#!/usr/bin/env python3
"""
AjouLLM Agent CLI - Interactive Terminal Interface

A beautiful command-line interface for the AjouLLM Agent, inspired by Claude Code.
...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        ...
        agent_name = _skin.get_branding("agent_name", "AjouLLM Agent") if _skin else "AjouLLM Agent"
...
class HermesCLI:
    """
    Interactive CLI for the AjouLLM Agent.
    ...
    def show_banner(self):
        ...
        if is_nous_hermes_non_agentic(model_name):
            ...
            self._console_print(
                ...
                "designed for use with AjouLLM Agent.[/]"
            )
            self._console_print(
    ...
    def run(self):
        ...
        try:
            ...
            _welcome_text = _welcome_skin.get_branding("welcome", "Welcome to AjouLLM Agent! Type your message or /help for commands.")
            _welcome_color = _welcome_skin.get_color("banner_text", "#FFF8DC")
        except Exception:
            _welcome_text = "Welcome to AjouLLM Agent! Type your message or /help for commands."
        ...
        def handle_ctrl_z(event):
            ...
            from prompt_toolkit.application import run_in_terminal
            from hermes_cli.skin_engine import get_active_skin
            agent_name = get_active_skin().get_branding("agent_name", "AjouLLM Agent")
...
def main(
    ...
    """
    AjouLLM Agent CLI - Interactive AI Assistant
